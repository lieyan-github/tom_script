...
; cut3P 简化版regex_cutThreeParts(arg_str, arg_正则分割字符串, arg_正则分割完整内容:="O)(.*?)({1})(.*)")
cut3P(arg_str, arg_正则分割字符串, arg_正则分割完整内容:="O)(.*?)({1})(.*)"){
    Return regex_cutThreeParts(arg_str, arg_正则分割字符串, arg_正则分割完整内容)
}
