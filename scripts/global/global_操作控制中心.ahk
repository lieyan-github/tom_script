...
; [ 常用功能设置]
; ----------------------------------------------------------
$Capslock::show_msg("Capslock 默认键屏蔽, 用ctrl + Capslock代替.")  ; 屏蔽Capslock键
^Capslock::Capslock
...
#del::批量关闭进程(["xigua.exe", "xgengine.exe", "MiniThunderPlatform.exe", "JJPlayer.exe", "hdacc.exe", "YodaoDict.exe", "YoudaoIE.exe", "MiPhoneHelper.exe"])
; ----------------------------------------------------------
; [全局]win & 数字          打开web
; ----------------------------------------------------------
#`::web网购()
