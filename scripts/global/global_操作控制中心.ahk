...
; ----------------------------------------------------------
; [全局]win & F1-F12        打开特殊常用操作
; ----------------------------------------------------------
^+#f1::打开ahk在线帮助()                                     ;
^#f1::打开ahk帮助()                                             ; AHK帮助

#esc::run %A_WorkingDir%\scripts\专用脚本\[tom实用工具] ffmpeg视频处理GUI.ahk
#f1::web网购()
#f2::web下载软件()
#f3::web查报价()
#f4::web财经()
